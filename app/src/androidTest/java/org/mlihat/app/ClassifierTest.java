...
import org.mlihat.app.tflite.Classifier;
...
public class ClassifierTest {
  ...
  @Rule
  public ActivityTestRule<ImageClassifier> rule =
      new ActivityTestRule<>(ImageClassifier.class);
  ...
  public void classificationResultsShouldNotChange() throws IOException {
    ImageClassifier activity = rule.getActivity();
    Classifier classifier = Classifier.create(activity, Model.ANJING, Device.CPU, 1);
